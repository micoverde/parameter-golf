...
export RUN_ID="${RUN_ID:-pr414_single_h100}"
...
export GPTQ_LITE_ENABLED="${GPTQ_LITE_ENABLED:-1}"
export GPTQ_LITE_PERCENTILES="${GPTQ_LITE_PERCENTILES:-0.9990,0.9995,0.9999,0.99999,1.0}"
